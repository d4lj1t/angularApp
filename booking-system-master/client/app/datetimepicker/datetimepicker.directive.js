  ...
  angular.module('ui.bootstrap.datetimepicker', [])
      ...
      .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
        ...
        var validateConfiguration = function validateConfiguration(configuration) {
          var validOptions = ['startView', 'minView', 'minuteStep', 'dropdownSelector', 'currentO'];
        ...
        return {
          ...
          '                       tooltip-placement="top" tooltip="This time has already been booked" tooltip-trigger="mouseenter" tooltip-enable="!dateObject.selectable"' +
          ...
          link: function link(scope, element, attrs, ngModelController) {
            ...
            var dataFactory = {
              ...
              day: function day(unixDate) {
                ...
                var yesterday = new moment().add('days', -1);
              ...
              hour: function hour(unixDate) {
                ...
                for (var i = 7; i < 19; i += 1) {
                  ...
                  if (hourMoment.isBefore(new Date())) {
                    isActive = false;
                  }


                  if (isActive) {
                    for (var bookingDates = 0; bookingDates < bookingData.length; bookingDates++) {
                      var booking = bookingData[bookingDates];

                      var bookingStartDate = new Date(booking.start);
                      var endDate = new Date(booking.end);

                      if (hourMoment.isBetween(bookingStartDate, endDate)) {
                        isActive = false;
                      }
                    }
                  }
            ...
            ngModelController.$render = function $render() {
              scope.bookings.$loaded(function (bookings) {
