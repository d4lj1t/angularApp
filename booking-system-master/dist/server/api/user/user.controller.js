...
exports.create = function (req, res, next) {
    ...
    newUser.save(function (err, user) {
        ...
        var mailOptions = {
            from: 'Elon Musk <me@boss.com>', // sender address
            to: user.email,
            subject: 'Bookingggggg System - Account Validation',
            html: "Hiiiiii " + user.name + "<br/>Please click on the link below to validate your account <br />" + emailAuthIdLink,
